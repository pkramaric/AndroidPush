...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                Flybits.include(HomeActivity.this).logout(new IRequestGeneralCallback() {
                    @Override
                    public void onSuccess() {
                        ...
                        Flybits.include(HomeActivity.this).updateContextLocation(location, new IRequestGeneralCallback() {
                            @Override
                            public void onSuccess() {
        ...
        btnLaunchPreferences.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                Flybits.include(HomeActivity.this).isUserLoggedIn(true, new IRequestLoggedIn() {
                    @Override
                    public void onLoggedIn(User user) {

                        stopProgressBar();
                        Intent intent = new Intent(HomeActivity.this, PushPreferencesActivity.class);
    ...
    public void login(final View v){
        ...
        Flybits.include(HomeActivity.this).isUserLoggedIn(true, new IRequestLoggedIn() {
            ...
            @Override
            public void onNotLoggedIn() {
                LoginOptions options = new LoginOptions.Builder(HomeActivity.this)
                        .loginAnonymously()
                        .setRememberMeToken()
                        .setDeviceOSVersion()
                        .build();

                Flybits.include(HomeActivity.this).login(options, new IRequestCallback<User>() {
                    @Override
